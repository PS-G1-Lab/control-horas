...
<div class="w-full lg:w-1/2 flex flex-col items-center">
  ...
  <div class="text-2xl my-8 text-pretty">
    {#if $appStatus === ROLE_STATUS.STUDENT}
      <p class="mb-5">
        Encuentra y contacta gratis con profesores particulares.
      </p>
      <p>
        Busca a tu profesor según tus necesidades, experiencia y presupuesto.
      </p>
    {:else if $appStatus === ROLE_STATUS.TEACHER}
      <p class="mb-5">
        Transmite tus conocimientos y gana dinero impartiendo clases
        particulares.
      </p>
